"""Load client teaching faculty into the database."""
...
def load_client_faculty() -> int:
    return load_client_teaching_faculty()
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "non-teaching":
        ...
        print(f"Loaded {teaching} teaching and {non_teaching} non-teaching faculty records.")
    else:
